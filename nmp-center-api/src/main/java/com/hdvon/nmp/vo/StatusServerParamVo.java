...
@Data
@ApiModel(value ="StatusServerParam")
public class StatusServerParamVo implements Serializable{/**
	 * 
	 */
	private static final long serialVersionUID = -9000108922943636262L;
	 @ApiModelProperty(value = "id")
	    private java.lang.String id;

	    @ApiModelProperty(value = "状态服务器名称")
	    private java.lang.String name;

	    @ApiModelProperty(value = "状态服务器编号")
	    private java.lang.String code;

	    @ApiModelProperty(value = "状态服务器ip")
	    private java.lang.String ip;

	    @ApiModelProperty(value = "状态服务器端口")
	    private java.lang.Integer port;

	    @ApiModelProperty(value = "domainName")
	    private java.lang.String domainName;

	    @ApiModelProperty(value = "状态服务器操作系统登录用户名")
	    private java.lang.String userName;

	    @ApiModelProperty(value = "状态服务器操作系统登录密码")
	    ...
	    @ApiModelProperty(value = "服务状态（1在线，0离线，-1 删除）默认离线")
