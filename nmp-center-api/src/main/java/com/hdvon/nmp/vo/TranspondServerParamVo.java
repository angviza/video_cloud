...
@Data
@ApiModel(value ="TranspondServerParam")
public class TranspondServerParamVo implements Serializable{

    /**
	 * 
	 */
	private static final long serialVersionUID = -5617050712096551889L;

	@ApiModelProperty(value = "id")
    private java.lang.String id;

    @ApiModelProperty(value = "转发服务器名称")
    private java.lang.String name;

    @ApiModelProperty(value = "转发服务器编码")
    private java.lang.String code;

    @ApiModelProperty(value = "转发服务器ip")
    private java.lang.String ip;

    @ApiModelProperty(value = "转发服务器端口号")
    private java.lang.Integer port;

    @ApiModelProperty(value = "转发服务器操作系统登录用户名")
    private java.lang.String userName;

    @ApiModelProperty(value = "转发服务器操作系统登录密码")
