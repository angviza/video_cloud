 ...
 *
 */
public class JedisReentrantLock extends AbstractLock {
	...
	public JedisReentrantLock(Jedis jedis) {
		this(jedis, DEFAULT_LOCK_KEY, DEFAULT_LOCK_EXPIRES);
	}
	
	public JedisReentrantLock(Jedis jedis, String lockKey, long lockExpires) {
		this.jedis = jedis;
