...
import com.hdvon.nmp.util.GenerateXls;
import com.hdvon.nmp.util.snowflake.IdGenerator;

public class DealData {
	private static final String url="jdbc:mysql://192.168.2.216:3306/zhvmp?useUnicode=true&characterEncoding=utf8&useSSL=false";
	...
	/**
	 * 生成数据到.xls文件
	 * @param tableName 要导出数据的表名
	 * @param isTree	是否是树形结构的数据
	 */
