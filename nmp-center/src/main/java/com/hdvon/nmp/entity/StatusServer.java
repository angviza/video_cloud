...
public class StatusServer implements Serializable{
    ...
    /**
     * 状态服务器名称 db_column: name 
     */
	private java.lang.String name;

    /**
     * 状态服务器编号 db_column: code 
     */
	private java.lang.String code;

    /**
     * 状态服务器ip db_column: ip 
     */
	private java.lang.String ip;

    /**
     * 状态服务器端口 db_column: port 
     */
    ...
    /**
     * 状态服务器操作系统登录用户名 db_column: user_name 
     */
    @Column(name = "user_name")
	private java.lang.String userName;

    /**
     * 状态服务器操作系统登录密码 db_column: password 
     */
