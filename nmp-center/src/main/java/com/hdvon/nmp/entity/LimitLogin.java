...
/**
 * <br>
 * <b>功能：</b>用户登录限制登录表 实体类<br>
 * <b>作者：</b>huangguanxin<br>
 * <b>日期：</b>2018<br>
 * <b>版权所有：<b>广州弘度信息科技有限公司 版权所有(C) 2018<br>
 */
@Data
@Table(name = "t_limit_login")
public class LimitLogin implements Serializable{
    ...
    /**
     * ip限制类型（0.限制的IP,1.允许的IP,限制mac地址） db_column: type 
     */
