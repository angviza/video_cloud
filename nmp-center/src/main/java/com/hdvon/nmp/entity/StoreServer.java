...
public class StoreServer implements Serializable{
    ...
    /**
     * 存储服务器名称 db_column: name 
     */
	private java.lang.String name;

    /**
     * 存储服务器编号 db_column: code 
     */
	private java.lang.String code;

    /**
     * 存储服务器ip db_column: ip 
     */
	private java.lang.String ip;

    /**
     * 存储服务器端口 db_column: port 
     */
	private java.lang.Integer port;

    /**
     * 存储服务器操作系统登录用户名 db_column: user_name 
     */
    @Column(name = "user_name")
	private java.lang.String userName;

    /**
     * 存储服务器操作系统登录密码 db_column: password 
     */
    ...
    /**
     * 存储类型 db_column: store_type 
     */
    @Column(name = "store_type")
	private java.lang.Integer storeType;

    /**
     * 录像默认保存天数 db_column: default_days 
     */
