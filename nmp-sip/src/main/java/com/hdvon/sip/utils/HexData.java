...
public class HexData {
	 ...
	 * @return
	 */
	private static String cloudControlHex(DirectionEnum em, int speed) {
...
//		Long checkCode = Long.parseLong(HexData.bytes2Hex(bit1.getBytes()) )
//				 + Long.parseLong(HexData.bytes2Hex(bit2.getBytes()) )
//				 + Long.parseLong(HexData.bytes2Hex(bit3.getBytes()) )
//				 + Long.parseLong(HexData.bytes2Hex(bit4.getBytes()) )
//				 + Long.parseLong(HexData.bytes2Hex(bit5.getBytes()) )
//				 + Long.parseLong(HexData.bytes2Hex(bit6.getBytes()) )
//				 + Long.parseLong(HexData.bytes2Hex(bit7.getBytes()) );
//		 checkCode = checkCode%256;
		 
//		 System.out.println(checkCode1 & 0xFF);
		 Long checkCode = byteSum(bit1)
				 ...
				 +byteSum(bit7);
		 checkCode = checkCode%256;
		 System.out.println(">>>>>>>>>>>>checkCode:"+checkCode+"===="+numToHex8(checkCode.intValue()));
...
//		long s1 = Long.parseLong(HexData.bytes2Hex(byteStr.getBytes()));
...
//		System.out.println(numToHex8(8));
		
		System.out.println(cloudControlHex(DirectionEnum.UP, 1));
	}
