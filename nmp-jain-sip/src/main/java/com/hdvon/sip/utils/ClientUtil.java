...
public class ClientUtil {
	 ...
	 * @return
	 */
	public static String getClientIp(HttpServletRequest request) throws SipSystemException{
	...
	public static String getLocalClientIp() throws SipSystemException{
		String ip = null;
		try {
	...
	public static InetAddress getLocalHostLANAddress() throws SipSystemException {
	    try {
	 ...
	 * @return
	 */
	public static List<String> getClientIpAndProt(String clientIp,int number) {
		...
		try{
			...
			throw new SipSystemException("生成本地端口错误！");
		}
		return list;
	}
	 ...
	 * @return
	 */
	public static List<Integer> creatProts(String clientIp, int number) {
	...
	public static String getClientMac() {
		...
		try {
			...
			throw new SipSystemException("获取本地mac地址出错！");
		}
		return macId;
	}
